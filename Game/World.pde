...
public class World
{
  ...
  public static final int KEY_NW=87;
  public static final int KEY_NE=69;
  public static final int KEY_SW=83;
  public static final int KEY_SE=68;
  ...
  private void createEnemy(int enemyNumber)
  {
    ...
    enemies.add(new Enemy(enemyNumber, new Location((int)random(World.MIN_CELL, World.MAX_CELL),(int)random(World.MIN_CELL, World.MAX_CELL))));
  }
  ...
  public void update(int keycode) 
  {
    if (player.isAlive())
    {
      ...
      {
        //enemies.add(new Enemy(enemies.size()+1, new Location((int)random(World.MIN_CELL, World.MAX_CELL),(int)random(World.MIN_CELL, World.MAX_CELL))));
  ...
  public void printLocationInfo()
  {
       ...
       for(Enemy e:enemies)
       {
         println("[X " + e.getLocation().getX() + "  Y: " + e.getLocation().getY() + "]");
       }
